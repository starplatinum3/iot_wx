...
Page({
  ...
  initLine() {
    ...
    wx.request({
      // url: app.globalData.baseUrl + `/hum/list`,
      // url: app.globalData.baseUrl + `/acc/list`,
      url: app.globalData.baseUrl + `/acc/last`,
      // url: 'https://baidu.com',
      // url: 'https://baidu.com',
      // url: 'http://baidu.com',
      method: "POST",
      ...
      success: function (res) {
        ...
        // var ftmTimeStr = crtTimeFtt(res.data.content[2].createTime)
        var ftmTimeStr = crtTimeFtt(content[2].createTime)
        //  console.log("crt");
        //  console.log(crt);
        // 怎么才能让那边知道我 修改了呢
        that.setData ({
        ...
        option.series[0].data = xs
        option.series[1].data = ys
        option.series[2].data = zs
        option.xAxis.data = dates
        console.log("dates");
        console.log(dates);
        // initChart()
